...
public class GaussProj : IProj
{
    ...
    public (double X, double Y, double gamma, double m) BLtoXY(double B, double L, double L0 = 0, double YKM = 0, double N0 = 0)
    {
        double l = L - L0;
        var r = BlToXy(B, l);
    ...
    public (double B, double L, double gamma, double m) XYtoBL(double X, double Y, double L0 = 0, double YKM = 0, double N0 = 0)
    {
        double y = Y - N0 * 1e6 - YKM * 1000;
        var r = XyToBl(X, y);
        return (r.B, r.l + L0, r.gamma, r.m);
    }
}